...
rot1 = [SKEW3(w1) -cross(w1,q1) ;0 0 0 1];
rot2 = [SKEW3(w2) -cross(w2,q2) ;0 0 0 1];
rot3 = [SKEW3(w3) -cross(w3,q3) ;0 0 0 1];
rot4 = [SKEW3(w4) -cross(w4,q4) ;0 0 0 1];
rot5 = [SKEW3(w5) -cross(w5,q5) ;0 0 0 1];
rot6 = [SKEW3(w6) -cross(w6,q6) ;0 0 0 1];
